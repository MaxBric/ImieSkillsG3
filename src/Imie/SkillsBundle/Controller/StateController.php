...
class StateController extends Controller {
  ...
  public function addAction(Request $req) {
    ...
    if ($form->isValid()) {
      try {
        ...
        $em->persist($state);
        $em->flush();
        $req->getSession()->getFlashBag()->add('success', 'Étape de projet ajoutée');
  ...
  public function modifyAction(Request $req, $id) {
    ...
    if ($form->isValid()) {
      try {
        $em->flush();
        $req->getSession()->getFlashBag()->add('success', 'Étape de projet modifiée');
  ...
  public function deleteAction(Request $req, $id) {
    ...
    try {
      $em->remove($state);
      $em->flush();
      $req->getSession()->getFlashBag()->add('success', 'Étape de projet supprimée !');
      return $this->redirect($this->generateUrl('imie_skills_state_index'));
    } catch (\Doctrine\DBAL\DBALException $e) {
